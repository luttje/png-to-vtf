...
Convert PNG images to VTF (Valve Texture Format) using Node.JS. For use in Source engine games like Garry's Mod, Counter-Strike, Team Fortress 2, and Half-Life 2.

> [!WARNING]
> This library was for 95% generated by an AI (Claude Opus 4.5) based on the [VTF specification](https://developer.valvesoftware.com/wiki/VTF_(Valve_Texture_Format)) and various online resources. While it has been tested and works for basic use cases, it should **not** be considered production-ready or fully compliant with all VTF features. Use at your own risk.
